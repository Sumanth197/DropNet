...
def oraclemodel(criterion, num_epochs = 100, percentile = 0.2, numtrials = 15, printvalue = True, 
    ...
    for trial in range(numtrials):
        ...
        for masktype in masktypes:
            ...
            while percent > 0.1:
                ...
                weights_after_training = model.state_dict() # model.get_weights()
                    ...
                    for v in mask.values():
                        for index in range(len(v)):
                            ...
                            if v[index] != 0:
                                ...
                                model = Model(mask).to(device)
                                model.load_state_dict(weights_after_training)
        ...
        printgraph(cache, 'oracle' + str(trial), numtrials = trial+1)
